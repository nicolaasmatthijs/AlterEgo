...
(function(){
	 ...
	 */
	alteregomd5.rstr_md5 = function(s)
	{
...
var alterego = {
  ...
  onPageUnload: function(aEvent) {
    if (aEvent.originalTarget instanceof HTMLDocument) {
		...
		var sourceHTML = doc.documentElement.innerHTML;
		...
		var contentlength=encodeURIComponent(sourceHTML.length);
		var md5sum=encodeURIComponent(alteregomd5.rstr_md5(sourceHTML));
		if (url != "about:blank" && url != "about%3Ablank" && url.substring(0,5) != "https" && !isNaN(duration)){
			var params = "uuid=" + uuid + "&duration=" + duration + "&url=" + url + "&contentlength=" + contentlength + "&md5sum=" + md5sum;
			xmlhttp.open("POST","http://alterego.caret.cam.ac.uk/createUserEntry.php",true);
  ...
  onMenuItemCommand: function(e) {
    ...
    promptService.alert(window, "AlterEgo 0.1",
