...
# Script that extracts data out of the HTML structure and generates
# an XML document for a specific page visit

*/

	// Make sure that the document can be kept in memory
