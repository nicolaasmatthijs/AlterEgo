...
# Page that will make a random division of all users into a development,
...
<?php
	...
	while($row = mysql_fetch_array($result)) {
		...
		// Make sure that every user has at least 500 page visits. If not, they are 
		// not included in any of the sets
