...
/**
 * Page that will process the results obtained in the relevance judgements experiment
 * and will draw some statistics out of it
 */
 -->
...
<%@page import="org.cl.nm417.data.EvaluationResult"%>
...
<%
	// Load the evaluation results in memory
	...
	int pclickRank = -1; EvaluationResult pclickResult = null;
	int rel005 = 0; int rel001 = 0;
	
	// Find the rank of Google, Teevan and PClick in the overall classification
	for (int i = 0; i < results.size(); i++){
		...
		} else if (results.get(i).getRerank().equalsIgnoreCase("pclick") && pclickRank == -1){
			pclickRank = i + 1;
			pclickResult = results.get(i);
		}
	}
	
	// Number of results that are significantly better than Google
	for (int i = 0; i < results.size(); i++){
...
<%
	...
	// Number of personalization strategies that are consistently better than Google, Teevan
	// and PClick. Consistently better means an improvements in NDCG for all users
	int googleConsistent = 0; int teevanConsistent = 0; int pclickConsistent = 0;
	...
	for (int i = 0; i < results.size(); i++){
		...
		if (res.getAaron() > pclickResult.getAaron() && res.getChristian() > pclickResult.getChristian() &&
		res.getFie() > pclickResult.getFie() && res.getNicolaas() > pclickResult.getNicolaas() &&
		res.getOszkar() > pclickResult.getOszkar() && res.getSimon() > pclickResult.getSimon()){
			pclickConsistent++;
		}
	}
...
<br/><br/>
Number of profile - reranking combination better than PClick: <b><%=pclickRank - 1%></b>
<br/>
Number of profile - reranking combination better than PClick for all users: <b><%=pclickConsistent - 1%></b>
...
<%
	...
	// Extra weight to previously visited URLs
...
<%
	...
	// Keep the Google rank into account
...
<%
	...
	// Extra weight to previosuly visited URLs
...
<%
	...
	// Compare No filtering to Google N-Gram filtering
	score1 = 0.0; score2 = 0.0;
	better1 = 0; better2 = 0;
	lookat = 0;
...
<%
	...
	// Compare No filtering to WordNet noun filtering
	score1 = 0.0; score2 = 0.0;
	better1 = 0; better2 = 0;
	lookat = 0;
...
<%
	...
	// Compare WordNet noun filtering to Google N-Gram filtering
	score1 = 0.0; score2 = 0.0;
	better1 = 0; better2 = 0;
	lookat = 0;
...
<%
	...
	// Compare using plain text to not using plain text
	score1 = 0.0; score2 = 0.0;
	better1 = 0; better2 = 0;
	lookat = 0;
...
<%
	...
	//Compare using relative plain text to not using plain text
	score1 = 0.0; score2 = 0.0;
	better1 = 0; better2 = 0;
	lookat = 0;
...
<%
	...
	//Compare using title to not using title
	score1 = 0.0; score2 = 0.0;
	better1 = 0; better2 = 0;
	lookat = 0;
...
<%
	...
	//Compare using relative title to not using title
	score1 = 0.0; score2 = 0.0;
	better1 = 0; better2 = 0;
	lookat = 0;
...
<%
	...
	//Compare using metadata description to not using metadata description
	score1 = 0.0; score2 = 0.0;
	better1 = 0; better2 = 0;
	lookat = 0;
...
<%
	...
	//Compare using relative metadata description to not using metadata description
	score1 = 0.0; score2 = 0.0;
	better1 = 0; better2 = 0;
	lookat = 0;
...
<%
	...
	//Compare using metadata keywords to not using metadata keywords
	score1 = 0.0; score2 = 0.0;
	better1 = 0; better2 = 0;
	lookat = 0;
...
<%
	...
	//Compare using relative metadata keywords to not using metadata keywords
	score1 = 0.0; score2 = 0.0;
	better1 = 0; better2 = 0;
	lookat = 0;
...
<%
	...
	//Compare using terms to not using terms
	score1 = 0.0; score2 = 0.0;
	better1 = 0; better2 = 0;
	lookat = 0;
...
<%
	...
	//Compare using relative terms to not using terms
	score1 = 0.0; score2 = 0.0;
	better1 = 0; better2 = 0;
	lookat = 0;
...
<%
	...
	//Compare using extracted noun phrases to not using extracted noun phrases
	score1 = 0.0; score2 = 0.0;
	better1 = 0; better2 = 0;
	lookat = 0;
...
<%
	...
	//Compare using relative extracted noun phrases to not using extracted noun phrases
	score1 = 0.0; score2 = 0.0;
	better1 = 0; better2 = 0;
	lookat = 0;
...
<%
	...
	//Compare Matching to Unique Matching
	score1 = 0.0; score2 = 0.0;
	better1 = 0; better2 = 0;
	lookat = 0;
...
<%
	...
	// Compare Matching to Language Model
	score1 = 0.0; score2 = 0.0;
	better1 = 0; better2 = 0;
	lookat = 0;
...
<%
	...
	// Compare Unique Matching to Language Model
	score1 = 0.0; score2 = 0.0;
	better1 = 0; better2 = 0;
	lookat = 0;
...
<%
	...
	//Compare Unique Matching to PClick
	score1 = 0.0; score2 = 0.0;
	better1 = 0; better2 = 0;
	lookat = 0;
...
<%
	...
	// Compare Language Model to PClick
	score1 = 0.0; score2 = 0.0;
	better1 = 0; better2 = 0;
	lookat = 0;
...
<%
	...
	// Compare giving extra weight to previously visited pages to not 
	// giving extra weight to previously visited pages
	score1 = 0.0; score2 = 0.0;
	better1 = 0; better2 = 0;
	lookat = 0;
...
<%
	...
	// Compare keeping Google rank into account to not keeping Google rank into account
	score1 = 0.0; score2 = 0.0;
	better1 = 0; better2 = 0;
	lookat = 0;
...
<%
	...
	// Collect the different combinations of input data sources
