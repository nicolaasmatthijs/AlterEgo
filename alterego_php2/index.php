...
<head>
    <title>AlterEgo 0.1 :: Add-on for Firefox</title>
...
<body class="html-ltr firefox user-anon inverse">
    ...
    <div class="section">
        <div id="header" role="banner">
        	<p id="title">
				<a href="#">Alter Ego 0.1 <em>for</em> <img alt="Firefox" src="img/firefox.png" /> <strong>Firefox</strong></a>
			</p>
		</div>
    			...
    			<div class="featured-inner object-lead inverse">
    				<div id="addon-summary-wrapper">
        				<div id="addon-summary" class="primary ">
            				<p >
              					Add-on that will attempt to learn your personal interests by observing your browsing behavior. It will use your personal interests to re-rank the output of search engines.	
							</p>
							<div id="addon-install">
                				<div id="install-25448-3f58e41f" class="install install-container">
									<p class="install-button platform-ALL">
            							<a href="alterego.xpi"  id="installTrigger12399-3f58e41f" addonName="Alter Ego 0.1" addonIcon="/img/alterego_icon.png" addonHash="sha256:b0c78d4efc8996b34d06fef30b1ba7fa25c049299c3f553fe85799e900672c8b" jsInstallMethod="browser_app_addon_install" frozen="false" class="button positive significant"><img src="img/plus-green-16x16.gif" alt="" /><span class="install-button-text">Download Now </span></a>
									</p>
            				...
            				<table summary="Add-on Information">
              					<tbody>
                    				...
                    				<tr>
                      					<th>Works with</th>
                      					<td>Firefox: 3.0 &ndash; 3.6.*</td>
                    				</tr>
                   	 				<tr>
                      					<th>Updated</th>
                                        <td><span title="February  20, 2010">February  20, 2010</span></td>
                    				</tr>
                                	<tr>
                  						<th>Developer</th>
