...
<%@page import="org.cl.nm417.extraction.UserProfile"%><html xmlns="http://www.w3.org/1999/xhtml">
<head>
...
<%
	...
	String[] methods = new String[]{"tfidf","bm25"};
	String[] filtering = new String[]{"posAll","posNoun","googlengram"};
	//String[] filtering = new String[]{"googlengram"};
									...
									for (Boolean b6: alternate){
										...
										for (Boolean b7: alternate){
											...
											if (!(b2 == false && b3 == false && b4 == false && b5 == false && b6 == false && b7 == false)){
												...
												String profilepath = "/Users/nicolaas/Desktop/AlterEgo/dataprocessing/data/profiles/" + user + "/" + extention + ".txt";
